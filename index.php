...
<main class="main">
      <section class="main__about wrapper" id="about" style="background-image: url(<?php echo get_theme_file_uri(
        ...
        <div class="main__about--inner">
          ...
          <img
            src="<?php echo get_theme_file_uri("/img/undraw_programmer_imem.svg")?>"
      ...
      <section class="main__skills wrapper" id="skills">
        <div class="main__skills--inner">
          ...
          <div class="main__skills--container">
            ...
            <div class="main__skills--item">
              <img
                src="<?php echo get_theme_file_uri( "/img/icon-javascript_vxwryl.svg" )?>"
                alt="JavaScript Logo"
              />
              <p>JavaScript</p>
            </div>
      ...
      <section class="main__portfolio" id="portfolio">
        ...
        <div class="main__portfolio--container">
          <a
            href="<?php echo site_url('/crowdfunding-page')?>"
            aria-label="View Crowdfunding Page Project"
            class="main__portfolio--item"
          >
            <img
              src="<?php echo get_theme_file_uri("/img/crowdfunding_project_trimmed.png")?>"
              alt="Crowdfunding Website"
              aria-label="View Blog Platform Page Project"
            />
            <span>Crowdfunding Website</span>
          </a>

          <a
            href="<?php echo site_url('/blogr-page')?>"
            aria-label="View Blog Platform Page Project"
            class="main__portfolio--item"
          >
            <img
              src="<?php echo get_theme_file_uri("/img/Blogr_project_trimmed.png")?>"
              alt="Blog Platform Website"
            />
            <span>Blog Platform Landing Page</span>
          </a>

          <a
            href="<?php echo site_url('/base-apparel-page')?>"
            class="main__portfolio--item"
          >
            <img
              src="<?php echo get_theme_file_uri( "/img/baseapparel-desktop.png" )?>"
              alt="Blog Platform Website"
            />
    ...
    <footer class="footer" id="contact" style="background-image: url(<?php echo get_theme_file_uri("/img/World\ Map\ Background.svg")?>)">
      <div class="footer__inner">
        ...
        <a href="mailto:xxxx@outlook.com" class="footer__item">
          <i class="fas fa-envelope footer__item--img-email"></i
          ><span>yukohorita@outlook.com</span>
        </a>
        <a
          href="https://www.linkedin.com/in/yuko-horita-5b597a21b"
          class="footer__item"
          target="blank"
        >
          <img
            src="<?php echo get_theme_file_uri( "/img/LI-In-Bug.png" )?>"
            alt=""
            class="footer__item--img-linkedin"
