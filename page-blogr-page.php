    ...
    <main class="main">
      <div class="main__details wrapper">
        <div class="main__details--inner">
          <h2 class="main__details--title">
            Blogr - Blog Platform Landing Page
          </h2>
          ...
          <div class="main__details--btn-container">
            <a
              href="https://blogr-landing-page-junior.vercel.app/"
              class="btn btn-livesite"
              target="_blank"
              >View Live Site</a
            >
            <a
              href="https://github.com/Sloth247/blogr-landing-page-junior"
      ...
      <div class="main__image-gallery wrapper">
        <img src="img/Blogr_project.png" alt="" class="blogr-img-1" />
        <img src="img/Blogr_project_nav.png" alt="" class="blogr-img-2" />
        <img src="img/Blogr_project_mobile.png" alt="" class="blogr-img-3" />
        <img
          src="img/Blogr_project_mobile_menu.png"
          alt=""
          class="blogr-img-4"
        />
      </div>
